...
const emergency = () => {
  return (
    ...
    <div className="h-full bg-blue p-7">
        ...
        <div className="max-w-[220px] flex items-center space-x-3 mx-auto md:mx-0 mb-5 px-6 py-4 bg-orange text-white font-semibold rounded-full text-center shadow-2xl shadow-orange-600/20">
    ...
    <div className="px-4 py-6 h-80 -order-1 md:order-1" style={{backgroundImage:`url('./one.jpg')`,backgroundRepeat:'no-repeat', backgroundSize:'cover',backgroundPosition:'center'}}></div>
    </section>
  )
}
